...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool screen_border, ImGuiWindowFlags flags);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool screen_border = true, float rounding = 0.0f);
