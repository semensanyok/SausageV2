...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    { bool screen_border = (style.WindowBorderSize > 0.0f); if (ImGui::Checkbox("WindowBorder", &screen_border)) { style.WindowBorderSize = screen_border ? 1.0f : 0.0f; } }
    ImGui::SameLine();
    { bool screen_border = (style.FrameBorderSize > 0.0f);  if (ImGui::Checkbox("FrameBorder",  &screen_border)) { style.FrameBorderSize  = screen_border ? 1.0f : 0.0f; } }
    ImGui::SameLine();
    { bool screen_border = (style.PopupBorderSize > 0.0f);  if (ImGui::Checkbox("PopupBorder",  &screen_border)) { style.PopupBorderSize  = screen_border ? 1.0f : 0.0f; } }
