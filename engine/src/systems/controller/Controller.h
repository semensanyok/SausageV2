...
class Controller : public SausageSystem {
public:
  Camera* camera;
  vector<ControllerEventProcessor*> processors;
  ...
  void AddProcessor(ControllerEventProcessor* processor) {
  ...
  void ProcessEvent(SDL_Event* e)
  {
    ...
    {
      for (ControllerEventProcessor* processor : processors) {
        processor->MouseWheelCallback(e->wheel);
      }
